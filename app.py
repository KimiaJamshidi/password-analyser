...
def analyse():
    ...
    return render_template("analyser.html", strength=strength, feedback=feedback, password=password, crack_time=crack_time, entropy=entropy, score=score, pwned_count=pwned_count, in_dictionary=in_dictionary, pattern_warnings=pattern_warnings, hashes=hashes)
...
def generate():
    ...
    return render_template("generator.html", generated=password, crack_time=crack_time, entropy=entropy, pwned_count=pwned_count, in_dictionary=in_dictionary, pattern_warnings=pattern_warnings, hashes=hashes)
...
def get_hashes(password):
    ...
    return {"MD5": md5, "SHA-1": sha1, "SHA-256": sha256}
